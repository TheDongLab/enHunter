...
task step6 {
    input {
      ...
      #I think I need to have an Array[File] here in order to localize inputs 
      Array[File] RDBG
      Array[File] meanRPM
      Int n_CPU
      Float GB_memory
  ...
  #Array[String] str_RDBG = RDBG
  #Array[String] str_meanRPM = meanRPM

  #File SamplemeanRPM = write_lines(str_meanRPM)
  #File SampleRDBGs = write_lines(str_RDBG)
