...
#TODO download DNase files for blood samples 
...
# TODO download enhancer regions from https://egg2.wustl.edu/roadmap/data/byDataType/dnase/BED_files_enh/ 

zcat regions_enh_*.bed.gz | sortBed | mergeBed -i - | awk '{OFS="\t"; print $0,"peak"NR }'> regions_enh_merged.blood.bed
split -l 1000 regions_enh_merged.blood.bed tmp.regions_enh_merged.blood.bed # split enhancer regions into 1000 length ??
...
################### TODO make all of the histone, DNase ... etc bigwig files 
