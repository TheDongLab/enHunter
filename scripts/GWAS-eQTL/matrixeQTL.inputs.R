...
# usage: Rscript matrixeQTL.inputs.R snps/eRNA.SNP_Matrix.revised.txt snps/snps.coordinates genes/eRNA.gene.Matrix.reordered.txt genes/gene.eRNA.coordinates covariate.reordered.txt all.cis.eQTL.txt
...
expression_file_name = expression_file;
gene_location_file_name = gene_location;

# Covariates file name
# Set to character() for no covariates
covariates_file_name = covariates_file;
