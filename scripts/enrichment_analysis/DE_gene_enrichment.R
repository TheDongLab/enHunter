# =============================
# actual DE analysis used 
# AB:  DE gene with DE eRNAs inside 
# nAB: DE gene without DE eRNAs inside 
# AnB: not DE gene with DE eRNAs inside 
# nAnB: not DE gene without DE eRNAs inside 
# =============================
...
#### NOTE: this was NOT used!!! (see below)
# =============================
